...
class TournamentsTest < ApplicationSystemTestCase
  ...
  test "creating a Tournament" do
    ...
    fill_in "Contact name", with: @tournament.contact_name
    fill_in "Contact phone number", with: @tournament.contact_phone_number
    fill_in "Name", with: @tournament.name
    fill_in "Tournament date", with: @tournament.tournament_date
